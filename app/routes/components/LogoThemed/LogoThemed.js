...
const logos = {
  ...
  fv_white: require('./../../../images/logos/farmavalue_logo_white.svg'),
  fv_red: require('./../../../images/logos/farmavalue_logo_red.svg')
}
...
const MainLogo = ({ className, ...otherProps }) => (
    <ThemeConsumer>
    {
        ({ style, color }) => (
            <img
